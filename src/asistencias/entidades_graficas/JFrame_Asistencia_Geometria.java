 ...
 * @author brall
 */
public class JFrame_Asistencia_Geometria extends javax.swing.JFrame {

    /**
     * Creates new form JFrame_Geometria
     */
    public JFrame_Asistencia_Geometria() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrame_Asistencia_Geometria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrame_Asistencia_Geometria().setVisible(true);
            }
        });
    }
